...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.card2).setOnClickListener(v ->
                Toast.makeText(MainActivity.this, "My Father Goes To Court Clicked", Toast.LENGTH_SHORT).show()
        );

        findViewById(R.id.card3).setOnClickListener(v ->
                Toast.makeText(MainActivity.this, "Obesity (Essay) Clicked", Toast.LENGTH_SHORT).show()
        );

        findViewById(R.id.card4).setOnClickListener(v ->
                Toast.makeText(MainActivity.this, "The God Stealer Clicked", Toast.LENGTH_SHORT).show()
        );

        findViewById(R.id.card5).setOnClickListener(v ->
                Toast.makeText(MainActivity.this, "The Philippines Battle Against Deforestation Clicked", Toast.LENGTH_SHORT).show()
        );
    }
}